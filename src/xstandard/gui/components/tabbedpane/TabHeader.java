...
public class TabHeader extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tabLabel = new xstandard.gui.components.tabbedpane.TabBoundLabel();
        btnCloseTab = new xstandard.gui.components.tabbedpane.TabCloseButton();
    ...
    private xstandard.gui.components.tabbedpane.TabCloseButton btnCloseTab;
    private xstandard.gui.components.tabbedpane.TabBoundLabel tabLabel;
