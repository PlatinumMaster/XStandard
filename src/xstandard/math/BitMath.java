...
public class BitMath {
	...
	public static int getIntegerBits(int n, int bitStartIdx, int bitCount) {
		int rsh = Long.SIZE - bitCount;
		return (int) ((n << (rsh - bitStartIdx)) >>> rsh);
	}
	...
	public static long makeMask64(int bitCount) {
		return (1L << (bitCount)) - 1L;
	}
	
	public static int bitLog2(int num) {
		if (num == 0) {
			return -1;
		}
